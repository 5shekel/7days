...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 303.0, 32.0, 420.0, 48.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 276.0, 36.0, 107.0, 48.0 ],
					"text" : "7days"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 437.5, 882.0, 37.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 254.5, 397.0, 37.0, 20.0 ],
					"text" : "store"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 472.0, 882.0, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 289.0, 397.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 523.0, 859.0, 100.0, 20.0 ],
					"text" : "closebang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 523.0, 901.0, 149.0, 18.0 ],
					"text" : "store 1, write settings.json"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 547.0, 879.0, 100.0, 20.0 ],
					"restore" : 					{
						"fadetime" : [ 3 ],
						"imagelength" : [ 5 ]
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 523.0, 928.0, 145.0, 20.0 ],
...
,
					"text" : "pattrstorage settings.json",
					"varname" : "settings.json"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 90.0, 567.0, 71.0, 20.0 ],
					"text" : "image"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 90.0, 596.0, 71.0, 20.0 ],
					"text" : "fade"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 117.0, 93.0, 45.0, 20.0 ],
									"text" : "* 1000"
								}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 34.0, 596.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 186.0, 263.0, 61.0, 41.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 34.0, 567.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 719.0, 134.0, 150.0, 103.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 34.0, 520.0, 432.0, 34.0 ],
					"text" : "to move to next image in the folder either wait (image_length) or  press SPACE\nif there is only one image in folder then this will do ntohing."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 719.0, 114.0, 150.0, 103.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 34.0, 486.0, 455.0, 34.0 ],
					"text" : "to play image  folder press its NUMBER  (1-7) on the keyboard\na second press on the number will start the video (video should start with a number)"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 197.833328, 261.5, 195.5, 261.5 ],
					"source" : [ "obj-104", 2 ]
				}
